...
mixin _$Group {
 ...
 String get uuid; String? get name; List<String> get players; int get amountMinImposters; int get amountMaxImposters; List<String> get categoryUuids; bool get imposterSeesCategoryName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Group&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.players, players)&&(identical(other.amountMinImposters, amountMinImposters) || other.amountMinImposters == amountMinImposters)&&(identical(other.amountMaxImposters, amountMaxImposters) || other.amountMaxImposters == amountMaxImposters)&&const DeepCollectionEquality().equals(other.categoryUuids, categoryUuids)&&(identical(other.imposterSeesCategoryName, imposterSeesCategoryName) || other.imposterSeesCategoryName == imposterSeesCategoryName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,name,const DeepCollectionEquality().hash(players),amountMinImposters,amountMaxImposters,const DeepCollectionEquality().hash(categoryUuids),imposterSeesCategoryName);

@override
String toString() {
  return 'Group(uuid: $uuid, name: $name, players: $players, amountMinImposters: $amountMinImposters, amountMaxImposters: $amountMaxImposters, categoryUuids: $categoryUuids, imposterSeesCategoryName: $imposterSeesCategoryName)';
}
...
@useResult
$Res call({
 String uuid, String? name, List<String> players, int amountMinImposters, int amountMaxImposters, List<String> categoryUuids, bool imposterSeesCategoryName
});
...
/// Create a copy of Group
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? name = freezed,Object? players = null,Object? amountMinImposters = null,Object? amountMaxImposters = null,Object? categoryUuids = null,Object? imposterSeesCategoryName = null,}) {
  return _then(Group(
